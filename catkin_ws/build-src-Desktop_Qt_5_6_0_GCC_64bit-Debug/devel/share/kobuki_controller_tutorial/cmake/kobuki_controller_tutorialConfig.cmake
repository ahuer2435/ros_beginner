...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_controller_tutorial_SOURCE_PREFIX /mnt/data/work/ssh_test/ros_beginner/catkin_ws/src/kobuki_controller_tutorial)
  set(kobuki_controller_tutorial_DEVEL_PREFIX /mnt/data/work/ssh_test/ros_beginner/catkin_ws/build-src-Desktop_Qt_5_6_0_GCC_64bit-Debug/devel)
  ...
  set(kobuki_controller_tutorial_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yanqiao <yanqiao@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'kobuki_controller_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/data/work/ssh_test/ros_beginner/catkin_ws/src/kobuki_controller_tutorial/${idir}'.  Ask the maintainer 'yanqiao <yanqiao@todo.todo>' to fix it.")
    endif()
